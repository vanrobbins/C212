            ...
            public void actionPerformed(ActionEvent event) {
                ...
                if (add) {
                    ...
                    if(selectedType.equals("Car")){
                        newVehicle = new Car(makeTxt, modelTxt, yearInt, mileageInt);
                    }
                    else if(selectedType.equals("Truck")){
                        newVehicle = new Truck(makeTxt, modelTxt, yearInt, mileageInt);
                    }
                    else if(selectedType.equals("Bike")){
                        newVehicle = new Bike(makeTxt, modelTxt, yearInt, mileageInt);
                    }
